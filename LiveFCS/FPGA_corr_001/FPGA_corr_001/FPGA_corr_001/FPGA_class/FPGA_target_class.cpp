...
//**********************************************************************************************************************
		NiFpga_SetStatus(&status,MNiFpga_Open(NiFpga_main_010_sched_5_Bitfile,NiFpga_main_010_sched_5_Signature,"RIO0",NiFpga_OpenAttribute_NoRun,session0));
		if(status!=0){ System::Console::Write("FPGA Open: ERR\n");  return -2; }
		else{System::Console::Write("FPGA Open: OK\n"); }
//**********************************************************************************************************************	
		NiFpga_SetStatus(&status,MNiFpga_ConfigureFifo(*session0,NiFpga_main_010_sched_5_TargetToHostFifoU32_FIFO,depth));
		if(status!=0){ 
...
//**********************************************************************************************************************	
		NiFpga_SetStatus(&status,MNiFpga_ConfigureFifo(*session0,NiFpga_main_010_sched_5_TargetToHostFifoU64_FIFO2,depth));
		if(status!=0){ 
...
//**********************************************************************************************************************
	unsigned long lenght=((8388608)/2);														//<<<================================================================================
	NiFpga_SetStatus(&status,MNiFpga_WriteU32(*session0,NiFpga_main_010_sched_5_ControlU32_y,lenght));     
...
if(sprunning==true){
	NiFpga_SetStatus(&status, MNiFpga_StopFifo(*session0,NiFpga_main_010_sched_5_TargetToHostFifoU32_FIFO));
	if(status!=0){System::Console::Write("STOP Fifo 2: ERR\n");}
	else{System::Console::Write("STOP Fifo 2: OK\n"); ni_DLL=NULL;}

	NiFpga_SetStatus(&status, MNiFpga_StopFifo(*session0,NiFpga_main_010_sched_5_TargetToHostFifoU64_FIFO2));
...
sprunning=true;
NiFpga_SetStatus(&status,MNiFpga_StartFifo(*session0,NiFpga_main_010_sched_5_TargetToHostFifoU32_FIFO));
if(status!=0){
...
NiFpga_SetStatus(&status,MNiFpga_StartFifo(*session0,NiFpga_main_010_sched_5_TargetToHostFifoU64_FIFO2));
if(status!=0){
